...
class ClustersControllerTest < ActionController::TestCase
  ...
  test "should create cluster" do
    assert_difference('Cluster.count') do
      post :create, cluster: { description: @cluster.description, name: @cluster.name, user_id: @cluster.user_id }
    end
  ...
  test "should update cluster" do
    patch :update, id: @cluster, cluster: { description: @cluster.description, name: @cluster.name, user_id: @cluster.user_id }
    assert_redirected_to cluster_path(assigns(:cluster))
  end
